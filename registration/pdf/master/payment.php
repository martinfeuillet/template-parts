...
<p>
	...
	if (
		...
		esc_html_e( 'Si la formation est co-financée par l\'entreprise, les quotes-parts sont mentionnées ci-dessous.', 'crea' );

	} else {

		esc_html_e( 'Si la formation est co-financée par l\'employeur/le responsable de stage, les quotes-parts sont mentionnées ci-dessous.', 'crea' );
	}
	?>
</p>
...
<table valign="top">
	<tr>
		...
		<td style="width: 10%; border-bottom: 1px dotted #000000;">
...
if ( 'master' === $formation_type ) {
	?>
	<p>
		<?php esc_html_e( 'Si tout ou partie des factures au titre des coûts d\'écolage sont à envoyer à l\'employeur/au responsable de stage : indiquer l\'adresse précise de facturation ci-dessous, puis ajouter le cachet de l\'employeur/du responsable de stage et la signature de la direction de l\'employeur/du responsable de stage à l\'emplacement réservé à cet effet sur la page de signatures du présent contrat d\'admission.', 'crea' ); ?>
	</p>
	<?php
}
?>
...
if ( 'brevet_federal' === $formation_type ) {
	?>
	<p>
		<?php esc_html_e( "Si la facture est à envoyer à l'entreprise : Indiquez l'adresse précise de facturation dans la section suivante, puis ajouter le cachet de l'entreprise et la signature de votre direction sur l'avant-dernière page du présent document.", 'crea' ); ?>
	</p>

	<p>
		<em>
			**<?php esc_html_e( 'Les participants aux cours préparatoires aux examens fédéraux pourront bénéficier d’un soutien financier fédéral, plus d’informations :', 'crea' ); ?> <a href="https://www.sbfi.admin.ch/sbfi/fr/home/formation/fps/contributions/participants.html" target="blank" rel="noopener">https://www.sbfi.admin.ch/sbfi/fr/home/formation/fps/contributions/participants.html</a>
		</em>
	</p>

	<p>
		<em>
			***<?php esc_html_e( 'Si la formation est financée en partie par une tierce personne ou une personne morale, la subvention proposée par la confédération n’est pas applicable.', 'crea' ); ?>
		</em>
	</p>
	<?php
}
