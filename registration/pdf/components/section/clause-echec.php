<?php
/**
 * Clauses - Échec - registration PDF
 *
...
<!-- En cas d'échec -->
<?php
$echec_clause = get_field( 'contract_clause_echec', $formation_id );

if ( ! empty( $echec_clause ) ) {
	?>
	...
	get_template_part(
		...
		array(
			...
			'title'  => __( 'Situation en cas d\'échec', 'crea' ),
		),
	);
	?>
