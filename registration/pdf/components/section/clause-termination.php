<?php
/**
 * Clause - Termination - registration PDF
 *
...
<?php
$termination_clause = get_field( 'termination_clause', $formation_id );

if ( ! empty( $termination_clause ) ) {
	?>
	...
	get_template_part(
		...
		array(
			...
			'title'  => __( 'Clause de résiliation', 'crea' ),
		),
	);
	?>
