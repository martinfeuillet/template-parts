	...
	<div class="line forms">
		...
		<div class="panel panel--parent" start="close">
			...
			<div class="parent-1 section">
				...
				<div class="form-control required">
					...
					<input type="text" name="contact1Surname" id="contact1Surname" required <?php
				...
				<div class="form-control required">
					...
					<input type="text" name="contact1Name" id="contact1Name" required <?php
				...
				<div class="form-control required">
					...
					<input type="text" name="contact1Profession" id="contact1Profession" <?php
				...
				<div class="form-control required form--address">
					...
					<input type="text" name="contact1Address" id="contact1Address" placeholder="<?php esc_html_e('Indiquez un lieu', 'crea'); ?>" onkeypress="return enterDisabled(event)" required <?php
				...
				<div class="form-control required form--nb">
					...
					<input type="text" name="contact1AddressNb" id="contact1AddressNb" required <?php
				...
				<div class="form-control required">
					...
					<input type="text" name="contact1City" id="contact1City" required <?php
				...
				<div class="form-control required">
					...
					<input type="email" name="contact1Mail" id="contact1Mail" required <?php
				...
				<div class="form-control">
					...
					<select name="contact1MobileCode" class="country_code_phone">
						<option value="41" data-iconurl="<?php echo esc_url(get_template_directory_uri()); ?>/assets/pics/flag_switzerland.svg" <?php
																																				if (isset($data['contact1MobileCode']) and $data['contact1MobileCode'] == '41') {
																																					echo 'selected="true"';
																																				}
																																				?>>+41</option>
						<option value="33" data-iconurl="<?php echo esc_url(get_template_directory_uri()); ?>/assets/pics/flag_france.svg" <?php
																																			if (isset($data['contact1MobileCode']) and $data['contact1MobileCode'] == '33') {
																																				echo 'selected="true"';
																																			}
																																			?>>+33</option>
						<option value="32" data-iconurl="<?php echo esc_url(get_template_directory_uri()); ?>/assets/pics/flag_belgium.svg" <?php
																																			if (isset($data['contact1MobileCode']) and $data['contact1MobileCode'] == '32') {
																																				echo 'selected="true"';
																																			}
																																			?>>+32</option>
						<option value="39" data-iconurl="<?php echo esc_url(get_template_directory_uri()); ?>/assets/pics/flag_italy.svg" <?php
																																			if (isset($data['contact1MobileCode']) and $data['contact1MobileCode'] == '39') {
																																				echo 'selected="true"';
																																			}
																																			?>>+39</option>
						<option value="44" data-iconurl="<?php echo esc_url(get_template_directory_uri()); ?>/assets/pics/flag_uk.svg" <?php
					...
					<input type="tel" name="contact1Mobile" <?php
			...
			<div class="parent-2 section">
				...
				<div class="form-control">
					...
					<input type="text" name="contact2Surname" id="contact2Surname" <?php
				...
				<div class="form-control">
					...
					<input type="text" name="contact2Name" id="contact2Name" <?php
				...
				<div class="form-control">
					...
					<input type="text" name="contact2Profession" id="contact2Profession" <?php
				...
				<div class="form-control form--address">
					...
					<input type="text" name="contact2Address" id="contact2Address" placeholder="<?php _e('Indiquez un lieu', 'crea'); ?>" onkeypress="return enterDisabled(event)" <?php
				...
				<div class="form-control form--nb">
					...
					<input type="text" name="contact2AddressNb" id="contact2AddressNb" <?php
				...
				<div class="form-control">
					...
					<input type="text" name="contact2City" id="contact2City" <?php
				...
				<div class="form-control">
					...
					<input type="email" name="contact2Mail" id="contact2Mail" <?php
				...
				<div class="form-control">
					...
					<input type="tel" name="contact2Mobile" <?php
		...
		<div class="panel" start="close">
			<div class="form-control required">
				...
				<input type="text" name="accountHolder" id="accountHolder" required <?php
			...
			<div class="form-control required">
				...
				<input type="text" name="accountCity" id="accountCity" required <?php
			...
			<div class="form-control required">
				...
				<input type="text" name="accountName" id="accountName" required <?php
			...
			<div class="form-control required">
				...
				<input type="text" name="accountIBAN" id="accountIBAN" required <?php
			...
			<div class="form-control">
				...
				<input type="text" name="accountClearing" id="accountClearing" <?php
			...
			<div class="form-control required">
				...
				<input type="text" name="accountSWIFT" id="accountSWIFT" required <?php
		...
		<div class="panel" start="close">
			<div class="school-1 section">
				...
				<div class="form-control required">
					...
					<input type="text" name="school1Name" required value="<?php echo isset($data['school1Name']) ? esc_attr($data['school1Name']) : ''; ?>">
				</div>
				...
				<div class="form-control required">
					...
					<select name="school1Level" id="school1Level" class="select-title">
						<?php foreach ($diploma_list as $parent => $childs) { ?>
							<option value="<?php echo esc_attr($parent); ?>" <?php
				...
				<div class="form-control required">
					...
					<input type="text" name="school1DiplomaName" required value="<?php echo isset($data['school1DiplomaName']) ? esc_attr($data['school1DiplomaName']) : ''; ?>">
				</div>
				...
				<div class="form-control required">
					...
					<input type="text" name="school1DiplomaYear" required <?php
			...
			<div class="school-2 section">
				...
				<div class="form-control">
					...
					<input type="text" name="school2Name" <?php
				...
				<div class="form-control">
					...
					<input type="text" name="school2DiplomaName" <?php
				...
				<div class="form-control">
					<label><?php _e('Diplôme obtenu', 'crea'); ?></label>
					<div class="radio-group">
						<input type="radio" name="school2HasDiploma" value="yes" id="school2DiplomaYes" <?php
					...
					<div class="radio-group">
						<input type="radio" name="school2HasDiploma" value="progress" id="school2DiplomaProgress" <?php
					...
					<div class="radio-group">
						<input type="radio" name="school2HasDiploma" value="no" id="school2DiplomaNo" <?php
				...
				<div class="form-control">
					<label><?php _e('Année du diplôme', 'crea'); ?></label>
					<input type="text" name="school2DiplomaYear" <?php
		...
		<div class="panel text-blue clauses" start="close">
			...
			<div class="clause__wrapper">
				<p class="text-title"><?php _e('Exclusion définitive durant la formation', 'crea'); ?></p>
				<div class="report__content"><?php echo wp_kses_post(wpautop(get_post_meta($formation_id, 'contract_clause_exclusion', true))); ?></div>
			</div>
